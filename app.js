...
const foods = ['pizza','cheeseburger'];
yummy.slice = ['sushi','cupcake']

console.log('Exercise 7 result:', yummy);


// /* indexOf يطلع لك مكان السترينق
...
// /* join تشكيل الفواصل بين السترنج
...
// /* includes هل موجود بين الاسترينق 
...
const foods = ['taco','sushi','cupcake','tofu','cheeseburger','soup'];
...
const nums = [1, 2, 3, 4, 5, 6, 9, 10, 12, 15, 18, 20]; // Example nums array
const fizz = [];
const buzz = [];
const fizzbuzz = [];
